...
export class Boss{
  ...
  update(dt,g){if(this.dead||g.player.dead)return;if(!Number.isFinite(this.cool))this.cool=0;if(!Number.isFinite(this.stun)||this.stun<0)this.stun=0;const p=g.player,d=dist(this,p);this.cool-=dt;if(this.stun>0){this.stun-=dt;return}this.phase=this.hp>10?1:this.hp>5?2:3;
