...
const TYPES={
 guard:{hp:2,speed:105,weapon:'pistol',fov:1.65,vision:350,hear:1,reaction:.46,color:'#5a3a44',accent:'#ff2e88'},
 brawler:{hp:2,speed:136,weapon:'baton',fov:1.9,vision:297,hear:1.05,reaction:.36,color:'#4a3f33',accent:'#ff7a1a'},
 shotgunner:{hp:2,speed:98,weapon:'shotgun',fov:1.55,vision:333,hear:1,reaction:.52,color:'#4a3a24',accent:'#c6ff2e'},
 hunter:{hp:2,speed:127,weapon:'smg',fov:1.75,vision:387,hear:1.1,reaction:.32,color:'#2f4440',accent:'#12e0ff'},
 elite:{hp:3,speed:140,weapon:'revolver',fov:2.05,vision:423,hear:1.2,reaction:.24,color:'#45254a',accent:'#8b2bff'}
};
export class Enemy{
