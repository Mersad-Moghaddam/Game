...
export class Player{
  ...
  draw(ctx){
    ...
    const h=res.hand;
    ctx.save();ctx.translate(h.x,h.y);drawWeaponArt(ctx,this.current,1,'#e0a97f');ctx.restore();
