...
export class Player{
  ...
  shoot(g){const w=this.current;if(w.ammo<=0){this.attackCd=.18;g.audio.play('empty');return}w.ammo--;this.attackCd=w.rate*this.rateMul+(w.cycle||0);g.fireWeapon(this,w,this.a+this.recoil);
