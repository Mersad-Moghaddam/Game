export class Input {
  constructor(canvas){
    ...
    const pos=e=>{const r=canvas.getBoundingClientRect();this.mouse.x=(e.clientX-r.left)/r.width*canvas.width;this.mouse.y=(e.clientY-r.top)/r.height*canvas.height;this.mouse.moved=true;};
