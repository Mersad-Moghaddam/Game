...
export class FX{
  ...
  smoke(x,y,a){const n=2+rng.int(2);for(let i=0;i<n;i++)this.p.push({x,y,vx:Math.cos(a)*rand(25,70)+rand(-18,18),vy:Math.sin(a)*rand(25,70)+rand(-18,18),life:rand(.3,.6),max:.6,size:rand(2,4.5),color:'#8a8a92',glow:false});}
